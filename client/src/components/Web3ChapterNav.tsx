    ...
    <div className="relative">
      ...
      <div
        className={`relative w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 ${
          isOpen
            ? "bg-indigo-500/30 border border-indigo-400/60 rotate-0"
      ...
      {!isOpen && (
        <div
          className="absolute -bottom-5 left-1/2 -translate-x-1/2 whitespace-nowrap text-[9px] text-slate-500 font-medium tracking-wider"
        >
          章节
        </div>
      )}
    ...
    <div ref={menuRef} className="relative" style={{ zIndex: 60 }}>
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 20px 60px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.04), inset 0 1px 0 rgba(255,255,255,0.06)",
        }}
      >
        {/* 菜单顶部标题 */}
        <div
        ...
        <div className="p-2 pt-1.5">
          ...
          >
              ...
              <svg
                className="w-3.5 h-3.5 text-yellow-600/60 group-hover:text-yellow-500 flex-shrink-0 transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
