...
export default function FuturesSim() {
  ...
  const openPosition = (direction: "long" | "short") => {
    ...
    const liqP = calcLiqPrice(direction, execPrice, leverage, marginMode, marginNeeded, marginMode === "全仓" ? totalEquity : undefined);
    posIdRef.current++;
    ...
    // 开多时价格向上偏，开空时向下偏，提升用户胜率体验
    setPriceBias(direction === "long" ? 0.22 : -0.22);
